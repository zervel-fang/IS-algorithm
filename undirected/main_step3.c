...
# include<time.h>
# include<math.h>
int *Degree, **Edges, **Neighbors ,M, N;  //M表示边数， N表示节点数 
...
void Init()  ;
// argv[1]:arenas-email argv[2]:deleta argv[3]:Realizations , 
...
int main(int agrs, char **argv){
	...
	time_t t1 ,t2;
	t1 = time(NULL)	 ;
	Iterate_Influence_label(atoi(argv[4]),argv) ;
	t2 = time(NULL) ;
	Generate_pij_weight() ;
	Output(argv) ;
